 ...
 * {@link Planet4Fragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Planet4Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Planet4Fragment extends Fragment {
     ...
     * @return A new instance of fragment Planet4Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Planet4Fragment newInstance(String param1, String param2) {
        Planet4Fragment fragment = new Planet4Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pImg.setImageResource(R.drawable.list_mercury);
        pImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), ViewPagerActivity.class);
                intent.putExtra("plno", 4);
                startActivity(intent);
            }
        });
        pName.setText("Mercury");
        plName.setText("Planet : Mercury ");
        ...
        iMg1.setImageResource(R.drawable.mercury1);
        iMg2.setImageResource(R.drawable.mercury2);
        iMg3.setImageResource(R.drawable.mercury3);

        bNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mListener.sendIdentifier4(true);
            }
        });
        ...
        bPrev.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mListener.sendIdentifier4(false);
            }
        });
        return view;
    }
